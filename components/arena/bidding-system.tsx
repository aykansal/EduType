...
export function BiddingSystem({ competitors }: BiddingSystemProps) {
  ...
  const placeBid = (competitorId: number) => {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-3">
        ...
        <h2 className="text-lg font-semibold text-cyan-400 font-tech">Quick Bet</h2>
      </div>
        ...
        {competitors.map((competitor) => (
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium text-gray-300">{competitor.name}</span>
