      ...
      <div className="p-8 md:p-12 relative">
        <div className="max-w-2xl">
          ...
          <p className="text-lg md:text-xl text-gray-800 mb-8">
            Games are loved by adults and children. Thats why Captain Ratatype has come up with a way to make typing lessons even more interesting and effective: just turn on the game mode!
          </p>
          <Button 
            size="lg"
