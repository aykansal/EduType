...
export function TypingInterface({ competitor, updateStats, isGameOver }) {
  ...
  const calculateStats = useCallback(() => {
    ...
    const correctCharacters = typedText
      .split("")
      .filter((char, index) => char === SAMPLE_TEXT[index]).length
  ...
  return (
    ...
    >
      <h3 className="text-xl font-bold mb-2 text-cyan-400 font-tech">
        {competitor.name}
      </h3>
